...
<div class="jumbotron">
    ...
    <h2><b><tag:welcome supplierName="${sessionScope.get('user').getSupplierName()}">Авторизируйтесь или зарегестрируйтесь для того чтобы подать предложение</tag:welcome></b></h2>
</div>
